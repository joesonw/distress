	...
	for _, metric := range metrics {
		...
		case *gauge:
			m.data.Gauge[data.name] = struct {
				...
				P9999:  mustFloat64(data.data.Percentile(0.9999)),
				P999:   mustFloat64(data.data.Percentile(0.999)),
				P99:    mustFloat64(data.data.Percentile(0.99)),
				P95:    mustFloat64(data.data.Percentile(0.95)),
				P90:    mustFloat64(data.data.Percentile(0.90)),
				P75:    mustFloat64(data.data.Percentile(0.75)),
				P50:    mustFloat64(data.data.Percentile(0.5)),
				Tags:   data.tags,
			}
		}
	}
